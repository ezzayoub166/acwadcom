...
class ControlCouponsState with _$ControlCouponsState {
  ...
  const factory ControlCouponsState.sucessgetRequestAdded({required List<Coupon> coupons,required List<CouponRequest> couponRequest}) = SucessgetRequestAdded;
  const factory ControlCouponsState.faluiregetRequestAdded({required String error}) = FaluiregetRequestAdded;
    const factory ControlCouponsState.loadingARCouponRequest() = LoadingARCouponRequest;

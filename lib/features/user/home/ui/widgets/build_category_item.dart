  ...
  return Padding(
    ...
    child: Column(
      children: [
        CircleAvatar(
          radius: 30,
          backgroundColor: itemIndex == selectedIndex
              ? ManagerColors.yellowColor.withOpacity(0.8)
              : ManagerColors.greyBackGroundCategore,
          child:
              (category.title["en"] == "Jewelry" && itemIndex == selectedIndex)
                  ? SvgPicture.asset("assets/images/iconJewelryBlue.svg")

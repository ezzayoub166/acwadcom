...
mixin _$SearchState {
  ...
  TResult when<TResult extends Object?>({
    ...
    required TResult Function(List<Coupon> results) loaded,
  ...
  TResult? whenOrNull<TResult extends Object?>({
    ...
    TResult? Function(List<Coupon> results)? loaded,
...
class _$SearchLoadedImpl implements SearchLoaded {
  const _$SearchLoadedImpl(final List<Coupon> results) : _results = results;

  final List<Coupon> _results;
  @override
  List<Coupon> get results {
...
abstract class SearchLoaded implements SearchState {
  const factory SearchLoaded(final List<Coupon> results) = _$SearchLoadedImpl;

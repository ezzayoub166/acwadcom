...
class _ChosenStatusScreenState extends State<ChosenStatusScreen> {
  Widget buildBtn(String title, VoidCallback onPressed, Color backgroundColor,
      ...
      body: Padding(
        ...
        child: Center(
          child: Column(
            ...
            children: [
              myImage("onBoarding_image_tow",
                  height: 294.h, width: double.infinity),
              RoundedButtonWgt(
                  title: AText.user.tr(context),
                  onPressed: () {
                    navigateAndFinishNamed(
                        context, Routes.signUpScreen, "USER");
                    // tYPEUSER = "USER";
                    // if(isLoggedInUser){
              ...
              buildSpacerH(20),
              RoundedButtonWgt(
                  title: AText.shopOwner.tr(context),
                  ...
                  onPressed: () {
                    ...
                    // tYPEUSER = "STOREOWNER";
                    navigateAndFinishNamed(
                        context, Routes.registerOwnerStore, "STOREOWNER");
                  }),
            ],
          ),
        ),

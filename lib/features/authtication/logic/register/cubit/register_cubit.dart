...
class RegisterCubit extends Cubit<RegisterState> {
 ...
 // other Atrribute for Login For Stotr Owener ...
  ...
  void emitRegisterStates() async{
    ...
    final newUser = UserModel(id: userCredential.user!.uid, userName: nameController.text.trim(), email: emailController.text.trim(), phoneNumber: phoneController.text.trim(), profilePicture: "", userType: UserType.normalUser , storeLink: "");

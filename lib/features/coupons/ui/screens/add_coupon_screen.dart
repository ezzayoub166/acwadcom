...
import 'package:acwadcom/features/coupons/ui/widgets/additional_terms_card_widget.dart';
import 'package:acwadcom/features/coupons/ui/widgets/select_drop_list.dart';
...
class _CreateCodeScreenState extends State<CreateCodeScreen> {
  ...
  Widget build(BuildContext context) {
      ...
      //! To Pass it to State ..
    final translatedCategoryTitle =
        AText.choseTheCategory.tr(context); 
                      ...
                      Column(
                        children: [
                          ...
                          SelectDropList(
                            ...
                            itemSelected: OptionItem(id: null , title: translatedCategoryTitle) ,
                            dropListModel: dropListModel,
                            onOptionSelected: (OptionItem optionItem) {
                              //** TOD Set State .... */
                              context.read<CreateCouponCubit>().selectCategory(optionItem);
                              // setState(() {
                            ...
                            textInputType: TextInputType.number,
                              ...
                              validator: (value) =>
                                  ManagerValidator.validateNumberOfUser(
                                      ...
                                      Column(
                                        children: [
                                          RoundedButtonWgt(title: AText.save.tr(context), onPressed: (){}),
                                          buildSpacerH(10.0),
  ...
  SizedBox buildExpireDataWidget(BuildContext context, DateTime? selectedDate) {
    return SizedBox(
                            ...
                            child: TextFormField(
                              ...
                              enabled:
                                  !isDateSelected, // Disable when a date is selected
                              style: TextStyle(
                                fontSize: 16.sp,
                                color: Colors.black,
                              ),
                                            ...
                                            builder: (BuildContext context) {
                                              ...
                                              return AdoptiveCalendar(
                                                backgroundColor: ManagerColors
                                                    .kCustomColor,
                                                barColor: ManagerColors
                                                    .kCustomColor,
                                                initialDate: DateTime.now(),
                                                onSelection: (dateTime) {
                                                  parentContext.read<CreateCouponCubit>().selectDate(dateTime??DateTime.now());
                                                  // setState(() {
                                                  //   pickedDate = dateTime;
                                                  //   isDateSelected = true;
